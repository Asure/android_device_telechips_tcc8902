...
//                    reportData[j + MotionEvent.SAMPLE_X] = w-reportData[j + MotionEvent.SAMPLE_X]; // VenomousNZ + Cleaned by Asure
// Reverted for now, works with correct data in /data/data/pointercal (chmod 777 it..)
//
// -15270 -58 58954176 16 10179 -5539352 65536 for X5A
//
                }
                if (absY != null) {
