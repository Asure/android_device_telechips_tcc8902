...
//
// VenomousNZ mods below
//

        private void calculateNewRotation(int orientation, int tiltAngle) {
            if (localLOGV) Log.i(TAG, orientation + ", " + tiltAngle + ", " + mRotation);
                int rotation=0; 
                if(orientation<135 && orientation>=45) { rotation=Surface.ROTATION_0; }
                else if(orientation<225 && orientation>=135) { rotation=Surface.ROTATION_90; }
                else if(orientation<315 && orientation>=225) { rotation=Surface.ROTATION_180; }
   		else if(orientation>=315 || orientation<45) { rotation=Surface.ROTATION_270; }
